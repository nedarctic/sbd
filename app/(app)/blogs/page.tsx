...
export const metadata: Metadata = {
    title: "ScholarBrood Blog – Academic Writing & Research Insights",
    description: "Read the latest academic writing tips, research strategies, publishing advice, and study insights from ScholarBrood to improve your scholarly productivity.",
    keywords: [
        "ScholarBrood",
        "academic writing",
        "research assistance",
