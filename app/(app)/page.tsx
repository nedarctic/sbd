...
export const metadata: Metadata = {
  title: "Academic Writing & Research Support – ScholarBrood",
  description: "Get expert academic writing, thesis help, research guidance, and publication support for students and researchers worldwide at ScholarBrood. Boost grades and publish with confidence.",
  keywords: [
        "ScholarBrood",
        "academic writing",
        "research assistance",
